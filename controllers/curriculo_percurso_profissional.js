...
const curriculo_percurso_profissional = require('../models/config_models').curriculo_percurso_profissional;
...
exports.cRud_getByCurriculoFK = async (req, res) => {
    ...
    curriculo_percurso_profissional.cRud_getByCurriculoFK({Id : req.params.Curriculo_FK})
    .then(result => {
