...
const curriculo_proeficiencia_idioma = require('../models/config_models').curriculo_proeficiencia_idioma;
...
exports.cRud_getByCurriculoFK = async (req, res) => {
    ...
    curriculo_proeficiencia_idioma.cRud_getByCurriculoFK({Id : req.params.Curriculo_FK})
    .then(result => {
